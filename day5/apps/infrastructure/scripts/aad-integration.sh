...
az rest --method PATCH --uri 'https://graph.microsoft.com/v1.0/applications/$UI_APP_OBJECTID' --headers 'Content-Type=application/json' --body '{\"spa\":{\"redirectUris\":[\"$UI_APP_REPLYURL"]}}'
